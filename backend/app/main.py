...
app = FastAPI(title="Adaptive Intelligent Market Research Bot API", version="1.9.0", lifespan=lifespan)
...
async def health() -> dict:
    return {"ok": True, "service": "adaptive-market-research-bot", "environment": settings.app_env}
